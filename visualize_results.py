...
if __name__ == '__main__':
    gt_dir = '/data/CD_DATA/LEVIR-CD/test/label'
    pred_dir = './levircd/levircd'
    dst_dir = './levircd/visual'
    img_dir = ['/data/CD_DATA/LEVIR-CD/test/A',
               '/data/CD_DATA/LEVIR-CD/test/B']
    ...
    for file_name in file_name_list:
        ...
        CDVisual(osp.join(pred_dir, "pred_"+file_name),
